...
<html lang="fr">
    ...
    <script>
    function select(){
        var param1 = document.getElementById("option").value;
        ...
        xmlhttp.onreadystatechange = function() {
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                ...
                tableau.innerHTML = "xmlhttp.readyState = "+xmlhttp.readyState +" "+ "xmlhttp.status = " + xmlhttp.status +" "+ xmlhttp.responseText;
            }
        };

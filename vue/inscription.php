...
<body>
    ...
    <div class="page">
        <div class="center">
        <?php
            if(isset($_GET['erreur']) && $_GET['erreur'] == "loginIsTake"){
                echo "<p> Ce nom d'utilisateur est déjà pris. Merci d'en choisir un autre.";
        } ?>
            <div class="title"><h1>Creation de votre compte</h1></div>
            ...
            <div class="info">
                ...
                <div class="input">
                    <form class="input_texte" method="post" action="../modele/inscription.php" onsubmit="return testInscription();">
